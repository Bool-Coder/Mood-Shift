  ...
  <div class="emotion-page">
    ...
    <main>
      ...
      <section class="hero">
        ...
        <p class="hero-text">
          And that's okay. You don't have to hide every emotion you feel.
      ...
      <section class="music-section">
        ...
        <div class="playlist-grid">
          ...
          <a
            href="https://music.youtube.com/playlist?list=PLDBUJxZ0r5lc"
            target="_blank"
          ...
          >
            ...
            <div class="playlist-content">
              ...
              <p>For the moments when you just need to let yourself feel.</p>
          ...
          <a
            href="https://music.youtube.com/playlist?list=PLC2-hsY_V15s"
            target="_blank"
            rel="noopener noreferrer"
            class="playlist-card"
          >
            <div class="playlist-cover night">
              <span>🌙</span>
            </div>
            ...
            <div class="playlist-content">
              ...
              <p>Slow songs for quiet moments and thoughts that won't stop.</p>
          ...
          <a
            href="https://music.youtube.com/playlist?list=PLJ62AjMYi-FA"
            target="_blank"
            rel="noopener noreferrer"
            class="playlist-card"
          >
            <div class="playlist-cover sunrise">
              <span>🌅</span>
            </div>
            ...
            <div class="playlist-content">
              ...
              <p>A little bit of hope for when you're ready for it.</p>
...
.rain {
  background: radial-gradient(circle at 30% 20%, #819fe8, #46548c 55%, #292b54);
}
